# 🏥 CHU Dialyse - Backend API

API REST du module Dialyse du CHU Andrianjato Fianarantsoa.

## 📋 Prérequis

- Node.js 18+
- MySQL 8.0+ (WampServer)
- NestJS CLI
...
```bash
npm install
cat > /d/projectCHU/dialyse-backend/src/prescription/prescription.service.spec.ts << 'ENDOFFILE'
